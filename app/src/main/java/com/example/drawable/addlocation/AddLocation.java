package com.example.drawable.addlocation;
...
import com.example.drawable.addlocation.mysql.Adapter;
import com.example.drawable.addlocation.mysql.ApiClient;
import com.example.drawable.addlocation.mysql.ApiInterface;
import com.example.drawable.addlocation.mysql.Pets;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listener = new Adapter.RecyclerViewClickListener() {
            ...
            public void onRowClick(View view, final int position) {
                ...
                Intent intent = new Intent(AddLocation.this, Editor.class);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(AddLocation.this, Editor.class));
            }
        });
    ...
    public void getPets(){
        ...
        call.enqueue(new Callback<List<Pets>>() {
            ...
            public void onResponse(Call<List<Pets>> call, Response<List<Pets>> response) {
                ...
                Log.i(AddLocation.class.getSimpleName(), response.body().toString());
                adapter = new Adapter(petsList, AddLocation.this, listener);
            ...
            public void onFailure(Call<List<Pets>> call, Throwable t) {
                Toast.makeText(AddLocation.this, "rp :"+
    ...
    public void updateLove(final String key, final int id, final Boolean love){
        ...
        call.enqueue(new Callback<Pets>() {
            ...
            public void onResponse(Call<Pets> call, Response<Pets> response) {
                ...
                Log.i(AddLocation.class.getSimpleName(), "Response "+response.toString());

                String value = response.body().getValue();
                String message = response.body().getMassage();

                if (value.equals("1")){
                    Toast.makeText(AddLocation.this, message, Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(AddLocation.this, message, Toast.LENGTH_SHORT).show();
                }
            ...
            public void onFailure(Call<Pets> call, Throwable t) {
                Toast.makeText(AddLocation.this, t.getMessage().toString(), Toast.LENGTH_SHORT).show();
            }
        });
    }
